...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  box-sizing: border-box;\n}\n\nbody {\n  background-color: #2fa8cc;\n  font-family: \"Roboto\", sans-serif;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100vh;\n  overflow: hidden;\n  margin: 0;\n  padding: 20px;\n}\n\n.container {\n  background-color: #f4f4f4;\n  border-radius: 10px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 50px 20px;\n  text-align: center;\n  max-width: 100%;\n  width: 800px;\n}\n\nh3 {\n  margin: 0;\n  opacity: 0.5;\n  letter-spacing: 2px;\n}\n\nimg {\n  width: 100px;\n  margin-bottom: 20px;\n}\n\n.joke {\n  font-size: 30px;\n  letter-spacing: 1px;\n  line-height: 40px;\n  margin: 50px auto;\n  max-width: 600px;\n}\n\n.btn {\n  background-color: #2fa8cc;\n  color: #f4f4f4;\n  border: 0;\n  border-radius: 10px;\n  box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n  padding: 14px 40px;\n  font-size: 16px;\n  cursor: pointer;\n}\n.btn:active {\n  transform: scale(0.98);\n}\n.btn:focus {\n  outline: 0;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAMA;EACC,sBAAA;AAJD;;AAOA;EACC,yBATe;EAUf,iCAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,aAAA;EACA,gBAAA;EACA,SAAA;EACA,aAAA;AAJD;;AAOA;EACC,yBArBiB;EAsBjB,mBAAA;EACA,wEAtBY;EAuBZ,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,YAAA;AAJD;;AAOA;EACC,SAAA;EACA,YAAA;EACA,mBAAA;AAJD;;AAOA;EACC,YAAA;EACA,mBAAA;AAJD;;AAOA;EACC,eAAA;EACA,mBAAA;EACA,iBAAA;EACA,iBAAA;EACA,gBAAA;AAJD;;AAOA;EACC,yBAnDe;EAoDf,cAnDiB;EAoDjB,SAAA;EACA,mBAAA;EACA,uEAAA;EACA,kBAAA;EACA,eAAA;EACA,eAAA;AAJD;AAMC;EACC,sBAAA;AAJF;AAOC;EACC,UAAA;AALF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');\n\n$primary-color: #2fa8cc;\n$secondary-color: #f4f4f4;\n$box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\n* {\n\tbox-sizing: border-box;\n}\n\nbody {\n\tbackground-color: $primary-color;\n\tfont-family: 'Roboto', sans-serif;\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tjustify-content: center;\n\theight: 100vh;\n\toverflow: hidden;\n\tmargin: 0;\n\tpadding: 20px;\n}\n\n.container {\n\tbackground-color: $secondary-color;\n\tborder-radius: 10px;\n\tbox-shadow: $box-shadow;\n\tpadding: 50px 20px;\n\ttext-align: center;\n\tmax-width: 100%;\n\twidth: 800px;\n}\n\nh3 {\n\tmargin: 0;\n\topacity: 0.5;\n\tletter-spacing: 2px;\n}\n\nimg {\n\twidth: 100px;\n\tmargin-bottom: 20px;\n}\n\n.joke {\n\tfont-size: 30px;\n\tletter-spacing: 1px;\n\tline-height: 40px;\n\tmargin: 50px auto;\n\tmax-width: 600px;\n}\n\n.btn {\n\tbackground-color: $primary-color;\n\tcolor: $secondary-color;\n\tborder: 0;\n\tborder-radius: 10px;\n\tbox-shadow: 0 5px 15px rgba(0, 0, 0, 0.1), 0 6px 6px rgba(0, 0, 0, 0.1);\n\tpadding: 14px 40px;\n\tfont-size: 16px;\n\tcursor: pointer;\n\n\t&:active {\n\t\ttransform: scale(0.98);\n\t}\n\n\t&:focus {\n\t\toutline: 0;\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/assets/laughing-emoji-svgrepo-com.svg":
/*!***************************************************!*\
  !*** ./src/assets/laughing-emoji-svgrepo-com.svg ***!
  \***************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "laughing-emoji-svgrepo-com.svg";
...
/* harmony import */ var _assets_laughing_emoji_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/laughing-emoji-svgrepo-com.svg */ "./src/assets/laughing-emoji-svgrepo-com.svg");



//no loaders are configured to process this file
var laughImg = document.getElementById('laughImg');
laughImg.src = _assets_laughing_emoji_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__;
...
/******/ })()
;
//# sourceMappingURL=bundle803873a9a2098ca57828.js.map